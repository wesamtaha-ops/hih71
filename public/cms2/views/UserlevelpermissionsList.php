...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fuserlevelpermissionssrch" id="fuserlevelpermissionssrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="on">
