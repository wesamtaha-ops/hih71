 ...
 */
class TeachersTrains extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // instituation
        $this->instituation = new DbField(
            $this, // Table
            'x_instituation', // Variable name
            'instituation', // Name
            '`instituation`', // Expression
            '`instituation`', // Basic search expression
            201, // Type
            300, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`instituation`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->instituation->InputTextType = "text";
        $this->instituation->Nullable = false; // NOT NULL field
        $this->instituation->Required = true; // Required field
        $this->instituation->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers_trains`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersTrainsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersTrainsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersTrainsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersTrainsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeachersTrainsView";
            case Config("API_ADD_ACTION"):
                return "TeachersTrainsAdd";
            case Config("API_EDIT_ACTION"):
                return "TeachersTrainsEdit";
            case Config("API_DELETE_ACTION"):
                return "TeachersTrainsDelete";
            case Config("API_LIST_ACTION"):
                return "TeachersTrainsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersTrainsView", $parm);
        } else {
            $url = $this->keyUrl("TeachersTrainsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeachersTrainsAdd?" . $parm;
        } else {
            $url = "TeachersTrainsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersTrainsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersTrainsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersTrainsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersTrainsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersTrainsDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // instituation
        $this->instituation->setupEditAttributes();
        $this->instituation->EditValue = $this->instituation->CurrentValue;
        $this->instituation->PlaceHolder = RemoveHtml($this->instituation->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->instituation);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->instituation);
