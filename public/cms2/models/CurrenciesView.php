 ...
 * Page class
 */
class CurrenciesView extends Currencies
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CurrenciesView";
    ...
    // CSS class/style
    public $CurrentPageName = "CurrenciesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CurrenciesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CurrenciesList"; // No matching record, return to list
                    } else {
