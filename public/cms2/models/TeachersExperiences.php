 ...
 */
class TeachersExperiences extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers_experiences`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersExperiencesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersExperiencesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersExperiencesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersExperiencesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeachersExperiencesView";
            case Config("API_ADD_ACTION"):
                return "TeachersExperiencesAdd";
            case Config("API_EDIT_ACTION"):
                return "TeachersExperiencesEdit";
            case Config("API_DELETE_ACTION"):
                return "TeachersExperiencesDelete";
            case Config("API_LIST_ACTION"):
                return "TeachersExperiencesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersExperiencesView", $parm);
        } else {
            $url = $this->keyUrl("TeachersExperiencesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeachersExperiencesAdd?" . $parm;
        } else {
            $url = "TeachersExperiencesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersExperiencesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersExperiencesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersExperiencesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersExperiencesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersExperiencesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "TeachersExperiencesList";
