 ...
 * Page class
 */
class LevelsDelete extends Levels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LevelsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "LevelsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LevelsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LevelsList"); // Return to list
                return;
            }
        }
