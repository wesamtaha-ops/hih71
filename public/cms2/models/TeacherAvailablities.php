 ...
 */
class TeacherAvailablities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->time->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teacher_availablities`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeacherAvailablitiesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeacherAvailablitiesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeacherAvailablitiesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeacherAvailablitiesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeacherAvailablitiesView";
            case Config("API_ADD_ACTION"):
                return "TeacherAvailablitiesAdd";
            case Config("API_EDIT_ACTION"):
                return "TeacherAvailablitiesEdit";
            case Config("API_DELETE_ACTION"):
                return "TeacherAvailablitiesDelete";
            case Config("API_LIST_ACTION"):
                return "TeacherAvailablitiesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeacherAvailablitiesView", $parm);
        } else {
            $url = $this->keyUrl("TeacherAvailablitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeacherAvailablitiesAdd?" . $parm;
        } else {
            $url = "TeacherAvailablitiesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeacherAvailablitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeacherAvailablitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeacherAvailablitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeacherAvailablitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeacherAvailablitiesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "TeacherAvailablitiesList";
