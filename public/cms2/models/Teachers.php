 ...
 */
class Teachers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // timezone
        $this->timezone = new DbField(
            $this, // Table
            'x_timezone', // Variable name
            'timezone', // Name
            '`timezone`', // Expression
            '`timezone`', // Basic search expression
            201, // Type
            300, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`timezone`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->timezone->InputTextType = "text";
        $this->timezone->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['timezone'] = &$this->timezone;

        // teacher_language
        $this->teacher_language = new DbField(
            $this, // Table
            'x_teacher_language', // Variable name
            'teacher_language', // Name
            '`teacher_language`', // Expression
            '`teacher_language`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`teacher_language`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->teacher_language->InputTextType = "text";
        $this->teacher_language->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['teacher_language'] = &$this->teacher_language;

        // video
        $this->video = new DbField(
            $this, // Table
            'x_video', // Variable name
            'video', // Name
            '`video`', // Expression
            '`video`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`video`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->video->InputTextType = "text";
        $this->video->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['video'] = &$this->video;

        // heading_ar
        $this->heading_ar = new DbField(
            $this, // Table
            'x_heading_ar', // Variable name
            'heading_ar', // Name
            '`heading_ar`', // Expression
            '`heading_ar`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`heading_ar`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->heading_ar->InputTextType = "text";
        $this->heading_ar->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['heading_ar'] = &$this->heading_ar;

        // description_ar
        $this->description_ar = new DbField(
            $this, // Table
            'x_description_ar', // Variable name
            'description_ar', // Name
            '`description_ar`', // Expression
            '`description_ar`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`description_ar`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->description_ar->InputTextType = "text";
        $this->description_ar->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['description_ar'] = &$this->description_ar;

        // heading_en
        $this->heading_en = new DbField(
            $this, // Table
            'x_heading_en', // Variable name
            'heading_en', // Name
            '`heading_en`', // Expression
            '`heading_en`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`heading_en`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->heading_en->InputTextType = "text";
        $this->heading_en->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['heading_en'] = &$this->heading_en;

        // description_en
        $this->description_en = new DbField(
            $this, // Table
            'x_description_en', // Variable name
            'description_en', // Name
            '`description_en`', // Expression
            '`description_en`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`description_en`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->description_en->InputTextType = "text";
        $this->description_en->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['description_en'] = &$this->description_en;

        // allow_express
        $this->allow_express = new DbField(
            $this, // Table
            'x_allow_express', // Variable name
            'allow_express', // Name
            '`allow_express`', // Expression
            '`allow_express`', // Basic search expression
            16, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`allow_express`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->allow_express->addMethod("getDefault", fn() => 0);
        $this->allow_express->InputTextType = "text";
        $this->allow_express->Nullable = false; // NOT NULL field
        $this->allow_express->Required = true; // Required field
        $this->allow_express->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->allow_express->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersView", $parm);
        } else {
            $url = $this->keyUrl("TeachersView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersEdit", $parm);
        } else {
            $url = $this->keyUrl("TeachersEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersAdd", $parm);
        } else {
            $url = $this->keyUrl("TeachersAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // heading_ar
        $this->heading_ar->setupEditAttributes();
        $this->heading_ar->EditValue = $this->heading_ar->CurrentValue;
        $this->heading_ar->PlaceHolder = RemoveHtml($this->heading_ar->caption());
        ...
        // heading_en
        $this->heading_en->setupEditAttributes();
        $this->heading_en->EditValue = $this->heading_en->CurrentValue;
        $this->heading_en->PlaceHolder = RemoveHtml($this->heading_en->caption());
        ...
        // allow_express
        $this->allow_express->setupEditAttributes();
        $this->allow_express->EditValue = $this->allow_express->CurrentValue;
        $this->allow_express->PlaceHolder = RemoveHtml($this->allow_express->caption());
        if (strval($this->allow_express->EditValue) != "" && is_numeric($this->allow_express->EditValue)) {
            $this->allow_express->EditValue = $this->allow_express->EditValue;
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->teacher_language);
                    $doc->exportCaption($this->video);
                    $doc->exportCaption($this->heading_ar);
                    $doc->exportCaption($this->description_ar);
                    $doc->exportCaption($this->heading_en);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->teacher_language);
                        $doc->exportField($this->video);
                        $doc->exportField($this->heading_ar);
                        $doc->exportField($this->description_ar);
                        $doc->exportField($this->heading_en);
