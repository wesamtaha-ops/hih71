 ...
 * Page class
 */
class ReviewsDelete extends Reviews
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReviewsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ReviewsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ReviewsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ReviewsList"); // Return to list
                return;
            }
        }
