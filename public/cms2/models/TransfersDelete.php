 ...
 * Page class
 */
class TransfersDelete extends Transfers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransfersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TransfersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TransfersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TransfersList"); // Return to list
                return;
            }
        }
