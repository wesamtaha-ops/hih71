 ...
 * Page class
 */
class TopicsView extends Topics
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "TopicsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TopicsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TopicsList"; // No matching record, return to list
                    } else {
