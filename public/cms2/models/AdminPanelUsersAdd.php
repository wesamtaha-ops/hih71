 ...
 * Page class
 */
class AdminPanelUsersAdd extends AdminPanelUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminPanelUsersAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminPanelUsersAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AdminPanelUsersView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // user_level
        if ($Security->canAdmin()) { // System admin
            $this->user_level->setDbValueDef($rsnew, $this->user_level->CurrentValue, "", false);
        }
