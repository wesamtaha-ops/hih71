 ...
 * Page class
 */
class TeachersPackagesView extends TeachersPackages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TeachersPackagesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TeachersPackagesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TeachersPackagesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TeachersPackagesList"; // No matching record, return to list
                    } else {
