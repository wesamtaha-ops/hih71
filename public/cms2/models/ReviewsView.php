 ...
 * Page class
 */
class ReviewsView extends Reviews
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReviewsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ReviewsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ReviewsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ReviewsList"; // No matching record, return to list
                    } else {
