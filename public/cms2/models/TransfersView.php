 ...
 * Page class
 */
class TransfersView extends Transfers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransfersView";
    ...
    // CSS class/style
    public $CurrentPageName = "TransfersView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TransfersList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TransfersList"; // No matching record, return to list
                    } else {
