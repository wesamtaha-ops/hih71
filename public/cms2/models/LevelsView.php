 ...
 * Page class
 */
class LevelsView extends Levels
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "LevelsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "LevelsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "LevelsList"; // No matching record, return to list
                    } else {
