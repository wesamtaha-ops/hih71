...
class OrdersSearch extends Orders
{
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->student_id); // student_id
        $this->buildSearchUrl($srchUrl, $this->teacher_id); // teacher_id
        $this->buildSearchUrl($srchUrl, $this->topic_id); // topic_id
        $this->buildSearchUrl($srchUrl, $this->date); // date
        $this->buildSearchUrl($srchUrl, $this->time); // time
        $this->buildSearchUrl($srchUrl, $this->fees); // fees
        $this->buildSearchUrl($srchUrl, $this->currency_id); // currency_id
        $this->buildSearchUrl($srchUrl, $this->status); // status
        $this->buildSearchUrl($srchUrl, $this->meeting_id); // meeting_id
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $curVal = trim(strval($this->student_id->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->student_id->AdvancedSearch->ViewValue = $this->student_id->lookupCacheOption($curVal);
            } else {
                $this->student_id->AdvancedSearch->ViewValue = $this->student_id->Lookup !== null && is_array($this->student_id->lookupOptions()) ? $curVal : null;
            }
            if ($this->student_id->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->student_id->EditValue = array_values($this->student_id->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = SearchFilter("`id`", "=", $this->student_id->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
            ...
            $curVal = trim(strval($this->teacher_id->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->teacher_id->AdvancedSearch->ViewValue = $this->teacher_id->lookupCacheOption($curVal);
            } else {
                $this->teacher_id->AdvancedSearch->ViewValue = $this->teacher_id->Lookup !== null && is_array($this->teacher_id->lookupOptions()) ? $curVal : null;
            }
            if ($this->teacher_id->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->teacher_id->EditValue = array_values($this->teacher_id->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = SearchFilter("`id`", "=", $this->teacher_id->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
            ...
            $curVal = trim(strval($this->topic_id->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->topic_id->AdvancedSearch->ViewValue = $this->topic_id->lookupCacheOption($curVal);
            } else {
                $this->topic_id->AdvancedSearch->ViewValue = $this->topic_id->Lookup !== null && is_array($this->topic_id->lookupOptions()) ? $curVal : null;
            }
            if ($this->topic_id->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->topic_id->EditValue = array_values($this->topic_id->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = SearchFilter("`id`", "=", $this->topic_id->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckNumber($this->fees->AdvancedSearch->SearchValue)) {
            $this->fees->addErrorMessage($this->fees->getErrorMessage(false));
        }
        if (!CheckInteger($this->package_id->AdvancedSearch->SearchValue)) {
