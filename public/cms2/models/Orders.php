...
class Orders extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // student_id
        $this->student_id = new DbField(
            $this, // Table
            'x_student_id', // Variable name
            'student_id', // Name
            '`student_id`', // Expression
            '`student_id`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`student_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->student_id->InputTextType = "text";
        $this->student_id->IsForeignKey = true; // Foreign key field
        $this->student_id->Nullable = false; // NOT NULL field
        $this->student_id->Required = true; // Required field
        $this->student_id->setSelectMultiple(false); // Select one
        ...
        $this->student_id->Lookup = new Lookup('student_id', 'users', false, 'id', ["name","","",""], '', '', [], [], [], [], [], [], '', '', "`name`");
        $this->student_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->student_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        // topic_id
        $this->topic_id = new DbField(
            $this, // Table
            'x_topic_id', // Variable name
            'topic_id', // Name
            '`topic_id`', // Expression
            '`topic_id`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`topic_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->topic_id->InputTextType = "text";
        $this->topic_id->setSelectMultiple(false); // Select one
        ...
        $this->topic_id->Lookup = new Lookup('topic_id', 'topics', false, 'id', ["name_ar","name_en","",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name_ar`, ''),'" . ValueSeparator(1, $this->topic_id) . "',COALESCE(`name_en`,''))");
        $this->topic_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->topic_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->time = new DbField(
            ...
            'time', // Name
            '`time`', // Expression
            '`time`', // Basic search expression
            201, // Type
            300, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`time`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        // meeting_id
        $this->meeting_id = new DbField(
            $this, // Table
            'x_meeting_id', // Variable name
            'meeting_id', // Name
            '`meeting_id`', // Expression
            '`meeting_id`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`meeting_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->meeting_id->InputTextType = "text";
        $this->meeting_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // package_id
        $this->package_id = new DbField(
            $this, // Table
            'x_package_id', // Variable name
            'package_id', // Name
            '`package_id`', // Expression
            '`package_id`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`package_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->package_id->InputTextType = "text";
        $this->package_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->package_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
