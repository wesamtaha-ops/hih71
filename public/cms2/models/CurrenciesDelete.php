 ...
 * Page class
 */
class CurrenciesDelete extends Currencies
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CurrenciesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CurrenciesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CurrenciesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CurrenciesList"); // Return to list
                return;
            }
        }
