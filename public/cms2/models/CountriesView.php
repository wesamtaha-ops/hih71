 ...
 * Page class
 */
class CountriesView extends Countries
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CountriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "CountriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CountriesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CountriesList"; // No matching record, return to list
                    } else {
