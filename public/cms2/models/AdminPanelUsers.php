...
/**
 * Table class for admin_panel_users
 */
class AdminPanelUsers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`admin_panel_users`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->user_level->Lookup = new Lookup('user_level', 'userlevels', false, 'UserLevelID', ["UserLevelName","","",""], '', '', [], [], [], [], [], [], '', '', "`UserLevelName`");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`admin_panel_users`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AdminPanelUsersList");
    }
    ...
    {
        global $Language;
        if ($pageName == "AdminPanelUsersView") {
            return $Language->phrase("View");
        } elseif ($pageName == "AdminPanelUsersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AdminPanelUsersAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AdminPanelUsersView";
            case Config("API_ADD_ACTION"):
                return "AdminPanelUsersAdd";
            case Config("API_EDIT_ACTION"):
                return "AdminPanelUsersEdit";
            case Config("API_DELETE_ACTION"):
                return "AdminPanelUsersDelete";
            case Config("API_LIST_ACTION"):
                return "AdminPanelUsersList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AdminPanelUsersView", $parm);
        } else {
            $url = $this->keyUrl("AdminPanelUsersView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "AdminPanelUsersAdd?" . $parm;
        } else {
            $url = "AdminPanelUsersAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdminPanelUsersEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdminPanelUsersList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdminPanelUsersAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdminPanelUsersList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AdminPanelUsersDelete");
        }
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `admin_panel_users`";
