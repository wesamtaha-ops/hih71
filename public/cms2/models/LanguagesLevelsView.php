 ...
 * Page class
 */
class LanguagesLevelsView extends LanguagesLevels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LanguagesLevelsView";
    ...
    // CSS class/style
    public $CurrentPageName = "LanguagesLevelsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "LanguagesLevelsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "LanguagesLevelsList"; // No matching record, return to list
                    } else {
