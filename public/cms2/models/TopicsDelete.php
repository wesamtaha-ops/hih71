 ...
 * Page class
 */
class TopicsDelete extends Topics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TopicsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TopicsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TopicsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TopicsList"); // Return to list
                return;
            }
        }
