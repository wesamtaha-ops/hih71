 ...
 * Page class
 */
class AdminPanelUsersEdit extends AdminPanelUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminPanelUsersEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminPanelUsersEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AdminPanelUsersList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("AdminPanelUsersList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "AdminPanelUsersList") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "AdminPanelUsersList") {
                            ...
                            $returnUrl = "AdminPanelUsersList"; // Return list page content
                        }
                    }
            ...
            if (!$Security->canAdmin()) { // System admin
                ...
                if ($this->user_level->ViewValue !== null) { // Load from cache
                    ...
                    if ($curVal == "") {
                        ...
                        $filterWrk = SearchFilter("`UserLevelID`", "=", $this->user_level->CurrentValue, DATATYPE_NUMBER, "");
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AdminPanelUsersList"), "", $this->TableVar, true);
        $pageId = "edit";
