...
jQuery(window).on("load", function() {
  ...
  jQuery(".tu-rangevalue").on("click",function() {
   ...
   if (stepsSlider !== null) {
     ...
     var input0_value = input0.value != "" ? input0.value : 1
     var input1_value = input1.value != "" ? input1.value : 600
     var inputs = [input0, input1];
 
     noUiSlider.create(stepsSlider, {
       start: [input0_value, input1_value],
       connect: true,
       range: {
         min: 0,
         max: 600,
