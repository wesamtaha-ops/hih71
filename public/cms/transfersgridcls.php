...
$transfers_grid = NULL; // Initialize page object first

class ctransfers_grid extends ctransfers {
	...
	// Page object name
	var $PageObjName = 'transfers_grid';

	// Grid form hidden field names
	var $FormName = 'ftransfersgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["transfers"];
