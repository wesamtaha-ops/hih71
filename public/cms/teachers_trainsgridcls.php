...
$teachers_trains_grid = NULL; // Initialize page object first

class cteachers_trains_grid extends cteachers_trains {
	...
	// Page object name
	var $PageObjName = 'teachers_trains_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_trainsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_trains"];
