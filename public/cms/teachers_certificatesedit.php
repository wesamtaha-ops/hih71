...
$teachers_certificates_edit = NULL; // Initialize page object first

class cteachers_certificates_edit extends cteachers_certificates {
	...
	// Page object name
	var $PageObjName = 'teachers_certificates_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("teachers_certificateslist.php"); // Return to list page
...
// Create page object
if (!isset($teachers_certificates_edit)) $teachers_certificates_edit = new cteachers_certificates_edit();

// Page init
$teachers_certificates_edit->Page_Init();

// Page main
$teachers_certificates_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$teachers_certificates_edit->Page_Render();
?>
...
var CurrentForm = fteachers_certificatesedit = new ew_Form("fteachers_certificatesedit", "edit");

// Validate form
fteachers_certificatesedit.Validate = function() {
...
fteachers_certificatesedit.Form_CustomValidate = 
...
fteachers_certificatesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $teachers_certificates_edit->ShowPageHeader(); ?>
<?php
$teachers_certificates_edit->ShowMessage();
?>
<?php if (!$teachers_certificates_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($teachers_certificates_edit->Pager)) $teachers_certificates_edit->Pager = new cPrevNextPager($teachers_certificates_edit->StartRec, $teachers_certificates_edit->DisplayRecs, $teachers_certificates_edit->TotalRecs, $teachers_certificates_edit->AutoHidePager) ?>
<?php if ($teachers_certificates_edit->Pager->RecordCount > 0 && $teachers_certificates_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($teachers_certificates_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $teachers_certificates_edit->PageUrl() ?>start=<?php echo $teachers_certificates_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($teachers_certificates_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $teachers_certificates_edit->PageUrl() ?>start=<?php echo $teachers_certificates_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $teachers_certificates_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($teachers_certificates_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $teachers_certificates_edit->PageUrl() ?>start=<?php echo $teachers_certificates_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($teachers_certificates_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $teachers_certificates_edit->PageUrl() ?>start=<?php echo $teachers_certificates_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $teachers_certificates_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fteachers_certificatesedit" id="fteachers_certificatesedit" class="<?php echo $teachers_certificates_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($teachers_certificates_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $teachers_certificates_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="teachers_certificates">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($teachers_certificates_edit->IsModal) ?>">
...
<?php if ($teachers_certificates->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_teachers_certificates_id" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->id->FldCaption() ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->id->CellAttributes() ?>>
<span id="el_teachers_certificates_id">
...
<input type="hidden" data-table="teachers_certificates" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($teachers_certificates->id->CurrentValue) ?>">
<?php echo $teachers_certificates->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($teachers_certificates->teacher_id->Visible) { // teacher_id ?>
	<div id="r_teacher_id" class="form-group">
		<label id="elh_teachers_certificates_teacher_id" for="x_teacher_id" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->teacher_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->teacher_id->CellAttributes() ?>>
...
<?php if ($teachers_certificates->university->Visible) { // university ?>
	<div id="r_university" class="form-group">
		<label id="elh_teachers_certificates_university" for="x_university" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->university->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->university->CellAttributes() ?>>
...
<?php if ($teachers_certificates->degree->Visible) { // degree ?>
	<div id="r_degree" class="form-group">
		<label id="elh_teachers_certificates_degree" for="x_degree" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->degree->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->degree->CellAttributes() ?>>
...
<?php if ($teachers_certificates->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_teachers_certificates_image" for="x_image" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->image->CellAttributes() ?>>
...
<?php if ($teachers_certificates->from_date->Visible) { // from_date ?>
	<div id="r_from_date" class="form-group">
		<label id="elh_teachers_certificates_from_date" for="x_from_date" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->from_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->from_date->CellAttributes() ?>>
...
<?php if ($teachers_certificates->to_date->Visible) { // to_date ?>
	<div id="r_to_date" class="form-group">
		<label id="elh_teachers_certificates_to_date" for="x_to_date" class="<?php echo $teachers_certificates_edit->LeftColumnClass ?>"><?php echo $teachers_certificates->to_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $teachers_certificates_edit->RightColumnClass ?>"><div<?php echo $teachers_certificates->to_date->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $teachers_certificates_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $teachers_certificates_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fteachers_certificatesedit.Init();
</script>
<?php
$teachers_certificates_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$teachers_certificates_edit->Page_Terminate();
?>
