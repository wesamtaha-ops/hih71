...
$teachers_certificates_grid = NULL; // Initialize page object first

class cteachers_certificates_grid extends cteachers_certificates {
	...
	// Page object name
	var $PageObjName = 'teachers_certificates_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_certificatesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_certificates"];
