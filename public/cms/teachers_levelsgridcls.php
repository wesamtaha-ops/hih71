...
$teachers_levels_grid = NULL; // Initialize page object first

class cteachers_levels_grid extends cteachers_levels {
	...
	// Page object name
	var $PageObjName = 'teachers_levels_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_levelsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_levels"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// level_id
			$this->level_id->SetDbValueDef($rsnew, $this->level_id->CurrentValue, 0, $this->level_id->ReadOnly);
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "teachers") {
			...
			if ($GLOBALS["teachers"]->EventCancelled) $this->EventCancelled = TRUE;
		}
