 ...
 */
class TeachersPackages extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // teacher_id
        $this->teacher_id = new DbField(
            $this, // Table
            'x_teacher_id', // Variable name
            'teacher_id', // Name
            '`teacher_id`', // Expression
            '`teacher_id`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`teacher_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->title_en = new DbField(
            $this, // Table
            'x_title_en', // Variable name
            'title_en', // Name
            '`title_en`', // Expression
            '`title_en`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`title_en`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->title_en->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['title_en'] = &$this->title_en;

        // title_ar
        $this->title_ar = new DbField(
            $this, // Table
            'x_title_ar', // Variable name
            'title_ar', // Name
            '`title_ar`', // Expression
            '`title_ar`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`title_ar`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->title_ar->Required = true; // Required field
        $this->title_ar->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->description_en->Nullable = false; // NOT NULL field
        $this->description_en->Required = true; // Required field
        $this->description_en->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->description_ar->Nullable = false; // NOT NULL field
        $this->description_ar->Required = true; // Required field
        $this->description_ar->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers_packages`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersPackagesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersPackagesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersPackagesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersPackagesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeachersPackagesView";
            case Config("API_ADD_ACTION"):
                return "TeachersPackagesAdd";
            case Config("API_EDIT_ACTION"):
                return "TeachersPackagesEdit";
            case Config("API_DELETE_ACTION"):
                return "TeachersPackagesDelete";
            case Config("API_LIST_ACTION"):
                return "TeachersPackagesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersPackagesView", $parm);
        } else {
            $url = $this->keyUrl("TeachersPackagesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeachersPackagesAdd?" . $parm;
        } else {
            $url = "TeachersPackagesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersPackagesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersPackagesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersPackagesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersPackagesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersPackagesDelete");
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->title_ar);
