 ...
 * Page class
 */
class TeachersPackagesDelete extends TeachersPackages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TeachersPackagesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TeachersPackagesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TeachersPackagesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TeachersPackagesList"); // Return to list
                return;
            }
        }
