 ...
 * Page class
 */
class AdminPanelUsersView extends AdminPanelUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminPanelUsersView";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminPanelUsersView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AdminPanelUsersList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AdminPanelUsersList"; // No matching record, return to list
                    } else {
