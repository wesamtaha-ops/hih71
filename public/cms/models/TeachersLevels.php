 ...
 */
class TeachersLevels extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->level_id->Nullable = false; // NOT NULL field
        $this->level_id->Required = true; // Required field
        $this->level_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->level_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers_levels`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersLevelsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersLevelsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersLevelsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersLevelsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeachersLevelsView";
            case Config("API_ADD_ACTION"):
                return "TeachersLevelsAdd";
            case Config("API_EDIT_ACTION"):
                return "TeachersLevelsEdit";
            case Config("API_DELETE_ACTION"):
                return "TeachersLevelsDelete";
            case Config("API_LIST_ACTION"):
                return "TeachersLevelsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersLevelsView", $parm);
        } else {
            $url = $this->keyUrl("TeachersLevelsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeachersLevelsAdd?" . $parm;
        } else {
            $url = "TeachersLevelsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersLevelsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersLevelsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersLevelsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersLevelsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersLevelsDelete");
        }
    }
