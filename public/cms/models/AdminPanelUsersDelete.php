 ...
 * Page class
 */
class AdminPanelUsersDelete extends AdminPanelUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminPanelUsersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminPanelUsersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AdminPanelUsersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("AdminPanelUsersList"); // Return to list
            return;
        }
