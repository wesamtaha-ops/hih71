...
class Topics extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->parent_id->Lookup = new Lookup('parent_id', 'topics', false, 'id', ["name_ar","name_en","",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name_ar`, ''),'" . ValueSeparator(1, $this->parent_id) . "',COALESCE(`name_en`,''))");
        $this->parent_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->parent_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`topics`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TopicsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TopicsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TopicsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TopicsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TopicsView", $parm);
        } else {
            $url = $this->keyUrl("TopicsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TopicsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TopicsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TopicsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TopicsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TopicsDelete");
        }
    }
