 ...
 */
class TeachersCertificates extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // university
        $this->university = new DbField(
            $this, // Table
            'x_university', // Variable name
            'university', // Name
            '`university`', // Expression
            '`university`', // Basic search expression
            201, // Type
            300, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`university`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->university->InputTextType = "text";
        $this->university->Nullable = false; // NOT NULL field
        $this->university->Required = true; // Required field
        $this->university->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['university'] = &$this->university;

        // degree
        $this->degree = new DbField(
            $this, // Table
            'x_degree', // Variable name
            'degree', // Name
            '`degree`', // Expression
            '`degree`', // Basic search expression
            201, // Type
            300, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`degree`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->degree->InputTextType = "text";
        $this->degree->Nullable = false; // NOT NULL field
        $this->degree->Required = true; // Required field
        $this->degree->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->from_date = new DbField(
            ...
            CastDateFieldForLike("`from_date`", 0, "DB"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->to_date = new DbField(
            ...
            'to_date', // Name
            '`to_date`', // Expression
            CastDateFieldForLike("`to_date`", 0, "DB"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`teachers_certificates`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TeachersCertificatesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TeachersCertificatesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TeachersCertificatesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TeachersCertificatesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TeachersCertificatesView";
            case Config("API_ADD_ACTION"):
                return "TeachersCertificatesAdd";
            case Config("API_EDIT_ACTION"):
                return "TeachersCertificatesEdit";
            case Config("API_DELETE_ACTION"):
                return "TeachersCertificatesDelete";
            case Config("API_LIST_ACTION"):
                return "TeachersCertificatesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TeachersCertificatesView", $parm);
        } else {
            $url = $this->keyUrl("TeachersCertificatesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TeachersCertificatesAdd?" . $parm;
        } else {
            $url = "TeachersCertificatesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersCertificatesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersCertificatesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersCertificatesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TeachersCertificatesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TeachersCertificatesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "TeachersCertificatesList";
    ...
    public function renderEditRow()
    {
        ...
        // university
        $this->university->setupEditAttributes();
        $this->university->EditValue = $this->university->CurrentValue;
        $this->university->PlaceHolder = RemoveHtml($this->university->caption());

        // degree
        $this->degree->setupEditAttributes();
        $this->degree->EditValue = $this->degree->CurrentValue;
        $this->degree->PlaceHolder = RemoveHtml($this->degree->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->university);
                    $doc->exportCaption($this->degree);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->university);
                        $doc->exportField($this->degree);
