 ...
 * Page class
 */
class CurriculumsView extends Curriculums
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CurriculumsView";
    ...
    // CSS class/style
    public $CurrentPageName = "CurriculumsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CurriculumsList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CurriculumsList"; // No matching record, return to list
                    } else {
