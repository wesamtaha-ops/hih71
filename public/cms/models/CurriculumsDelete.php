 ...
 * Page class
 */
class CurriculumsDelete extends Curriculums
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CurriculumsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CurriculumsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CurriculumsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CurriculumsList"); // Return to list
                return;
            }
        }
