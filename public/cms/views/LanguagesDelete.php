...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_languages_id" class="languages_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->name_ar->Visible) { // name_ar ?>
        <th class="<?= $Page->name_ar->headerCellClass() ?>"><span id="elh_languages_name_ar" class="languages_name_ar"><?= $Page->name_ar->caption() ?></span></th>
<?php } ?>
<?php if ($Page->name_en->Visible) { // name_en ?>
        <th class="<?= $Page->name_en->headerCellClass() ?>"><span id="elh_languages_name_en" class="languages_name_en"><?= $Page->name_en->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
