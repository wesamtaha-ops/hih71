...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="fuserlevelpermissionsedit" id="fuserlevelpermissionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
