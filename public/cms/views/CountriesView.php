...
<?php } ?>
<?php } ?>
<form name="fcountriesview" id="fcountriesview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_countries_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->name_ar->Visible) { // name_ar ?>
    <tr id="r_name_ar"<?= $Page->name_ar->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_countries_name_ar"><?= $Page->name_ar->caption() ?></span></td>
...
<?php if ($Page->name_en->Visible) { // name_en ?>
    <tr id="r_name_en"<?= $Page->name_en->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_countries_name_en"><?= $Page->name_en->caption() ?></span></td>
