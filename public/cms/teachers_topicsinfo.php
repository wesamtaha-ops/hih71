...
$teachers_topics = NULL;

//
// Table class for teachers_topics
//
class cteachers_topics extends cTable {
	var $teacher_id;
	var $topic_id;
	...
	function __construct() {
		...
		$this->TableVar = 'teachers_topics';
		$this->TableName = 'teachers_topics';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`teachers_topics`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// teacher_id
		$this->teacher_id = new cField('teachers_topics', 'teachers_topics', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 19, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// topic_id
		$this->topic_id = new cField('teachers_topics', 'teachers_topics', 'x_topic_id', 'topic_id', '`topic_id`', '`topic_id`', 19, -1, FALSE, '`topic_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`teachers_topics`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "teachers_topicslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "teachers_topicsview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "teachers_topicsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "teachers_topicsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("teachers_topicsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("teachers_topicsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "teachers_topicsadd.php?" . $this->UrlParm($parm);
		else
			$url = "teachers_topicsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("teachers_topicsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("teachers_topicsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("teachers_topicsdelete.php", $this->UrlParm());
	}
