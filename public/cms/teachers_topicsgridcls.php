...
$teachers_topics_grid = NULL; // Initialize page object first

class cteachers_topics_grid extends cteachers_topics {
	...
	// Page object name
	var $PageObjName = 'teachers_topics_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_topicsgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_topics"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// topic_id
			$this->topic_id->SetDbValueDef($rsnew, $this->topic_id->CurrentValue, 0, $this->topic_id->ReadOnly);
