...
$teachers_trains_delete = NULL; // Initialize page object first

class cteachers_trains_delete extends cteachers_trains {
	...
	// Page object name
	var $PageObjName = 'teachers_trains_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("teachers_trainslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in teachers_trains class, teachers_trainsinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("teachers_trainslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($teachers_trains_delete)) $teachers_trains_delete = new cteachers_trains_delete();

// Page init
$teachers_trains_delete->Page_Init();

// Page main
$teachers_trains_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$teachers_trains_delete->Page_Render();
?>
...
var CurrentForm = fteachers_trainsdelete = new ew_Form("fteachers_trainsdelete", "delete");

// Form_CustomValidate event
fteachers_trainsdelete.Form_CustomValidate = 
...
fteachers_trainsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $teachers_trains_delete->ShowPageHeader(); ?>
<?php
$teachers_trains_delete->ShowMessage();
?>
<form name="fteachers_trainsdelete" id="fteachers_trainsdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($teachers_trains_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $teachers_trains_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="teachers_trains">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($teachers_trains_delete->RecKeys as $key) { ?>
...
<?php if ($teachers_trains->id->Visible) { // id ?>
		<th class="<?php echo $teachers_trains->id->HeaderCellClass() ?>"><span id="elh_teachers_trains_id" class="teachers_trains_id"><?php echo $teachers_trains->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers_trains->teacher_id->Visible) { // teacher_id ?>
		<th class="<?php echo $teachers_trains->teacher_id->HeaderCellClass() ?>"><span id="elh_teachers_trains_teacher_id" class="teachers_trains_teacher_id"><?php echo $teachers_trains->teacher_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers_trains->instituation->Visible) { // instituation ?>
		<th class="<?php echo $teachers_trains->instituation->HeaderCellClass() ?>"><span id="elh_teachers_trains_instituation" class="teachers_trains_instituation"><?php echo $teachers_trains->instituation->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers_trains->subject->Visible) { // subject ?>
		<th class="<?php echo $teachers_trains->subject->HeaderCellClass() ?>"><span id="elh_teachers_trains_subject" class="teachers_trains_subject"><?php echo $teachers_trains->subject->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers_trains->from_date->Visible) { // from_date ?>
		<th class="<?php echo $teachers_trains->from_date->HeaderCellClass() ?>"><span id="elh_teachers_trains_from_date" class="teachers_trains_from_date"><?php echo $teachers_trains->from_date->FldCaption() ?></span></th>
<?php } ?>
<?php if ($teachers_trains->to_date->Visible) { // to_date ?>
		<th class="<?php echo $teachers_trains->to_date->HeaderCellClass() ?>"><span id="elh_teachers_trains_to_date" class="teachers_trains_to_date"><?php echo $teachers_trains->to_date->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$teachers_trains_delete->RecCnt = 0;
$i = 0;
while (!$teachers_trains_delete->Recordset->EOF) {
	$teachers_trains_delete->RecCnt++;
	$teachers_trains_delete->RowCnt++;

	// Set row properties
	$teachers_trains->ResetAttrs();
	$teachers_trains->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$teachers_trains_delete->LoadRowValues($teachers_trains_delete->Recordset);

	// Render row
	$teachers_trains_delete->RenderRow();
?>
	<tr<?php echo $teachers_trains->RowAttributes() ?>>
<?php if ($teachers_trains->id->Visible) { // id ?>
		<td<?php echo $teachers_trains->id->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_id" class="teachers_trains_id">
...
<?php } ?>
<?php if ($teachers_trains->teacher_id->Visible) { // teacher_id ?>
		<td<?php echo $teachers_trains->teacher_id->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_teacher_id" class="teachers_trains_teacher_id">
...
<?php } ?>
<?php if ($teachers_trains->instituation->Visible) { // instituation ?>
		<td<?php echo $teachers_trains->instituation->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_instituation" class="teachers_trains_instituation">
...
<?php } ?>
<?php if ($teachers_trains->subject->Visible) { // subject ?>
		<td<?php echo $teachers_trains->subject->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_subject" class="teachers_trains_subject">
...
<?php } ?>
<?php if ($teachers_trains->from_date->Visible) { // from_date ?>
		<td<?php echo $teachers_trains->from_date->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_from_date" class="teachers_trains_from_date">
...
<?php } ?>
<?php if ($teachers_trains->to_date->Visible) { // to_date ?>
		<td<?php echo $teachers_trains->to_date->CellAttributes() ?>>
<span id="el<?php echo $teachers_trains_delete->RowCnt ?>_teachers_trains_to_date" class="teachers_trains_to_date">
...
<?php
	$teachers_trains_delete->Recordset->MoveNext();
}
$teachers_trains_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $teachers_trains_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fteachers_trainsdelete.Init();
</script>
<?php
$teachers_trains_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$teachers_trains_delete->Page_Terminate();
?>
