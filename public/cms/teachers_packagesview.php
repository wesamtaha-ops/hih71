...
$teachers_packages_view = NULL; // Initialize page object first

class cteachers_packages_view extends cteachers_packages {
	...
	// Page object name
	var $PageObjName = 'teachers_packages_view';
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "teachers_packageslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "teachers_packageslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($teachers_packages_view)) $teachers_packages_view = new cteachers_packages_view();

// Page init
$teachers_packages_view->Page_Init();

// Page main
$teachers_packages_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$teachers_packages_view->Page_Render();
?>
...
var CurrentForm = fteachers_packagesview = new ew_Form("fteachers_packagesview", "view");

// Form_CustomValidate event
fteachers_packagesview.Form_CustomValidate = 
...
fteachers_packagesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $teachers_packages_view->ExportOptions->Render("body") ?>
<?php
	foreach ($teachers_packages_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $teachers_packages_view->ShowPageHeader(); ?>
<?php
$teachers_packages_view->ShowMessage();
?>
<?php if (!$teachers_packages_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($teachers_packages_view->Pager)) $teachers_packages_view->Pager = new cPrevNextPager($teachers_packages_view->StartRec, $teachers_packages_view->DisplayRecs, $teachers_packages_view->TotalRecs, $teachers_packages_view->AutoHidePager) ?>
<?php if ($teachers_packages_view->Pager->RecordCount > 0 && $teachers_packages_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($teachers_packages_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $teachers_packages_view->PageUrl() ?>start=<?php echo $teachers_packages_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($teachers_packages_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $teachers_packages_view->PageUrl() ?>start=<?php echo $teachers_packages_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $teachers_packages_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($teachers_packages_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $teachers_packages_view->PageUrl() ?>start=<?php echo $teachers_packages_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($teachers_packages_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $teachers_packages_view->PageUrl() ?>start=<?php echo $teachers_packages_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $teachers_packages_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fteachers_packagesview" id="fteachers_packagesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($teachers_packages_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $teachers_packages_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="teachers_packages">
<input type="hidden" name="modal" value="<?php echo intval($teachers_packages_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($teachers_packages->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_teachers_packages_id"><?php echo $teachers_packages->id->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_teachers_packages_teacher_id"><?php echo $teachers_packages->teacher_id->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->title_en->Visible) { // title_en ?>
	<tr id="r_title_en">
		<td class="col-sm-2"><span id="elh_teachers_packages_title_en"><?php echo $teachers_packages->title_en->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->title_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->title_ar->Visible) { // title_ar ?>
	<tr id="r_title_ar">
		<td class="col-sm-2"><span id="elh_teachers_packages_title_ar"><?php echo $teachers_packages->title_ar->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->title_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->description_en->Visible) { // description_en ?>
	<tr id="r_description_en">
		<td class="col-sm-2"><span id="elh_teachers_packages_description_en"><?php echo $teachers_packages->description_en->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->description_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->description_ar->Visible) { // description_ar ?>
	<tr id="r_description_ar">
		<td class="col-sm-2"><span id="elh_teachers_packages_description_ar"><?php echo $teachers_packages->description_ar->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->description_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_teachers_packages_image"><?php echo $teachers_packages->image->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->fees->Visible) { // fees ?>
	<tr id="r_fees">
		<td class="col-sm-2"><span id="elh_teachers_packages_fees"><?php echo $teachers_packages->fees->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->fees->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->currency_id->Visible) { // currency_id ?>
	<tr id="r_currency_id">
		<td class="col-sm-2"><span id="elh_teachers_packages_currency_id"><?php echo $teachers_packages->currency_id->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->currency_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->created_at->Visible) { // created_at ?>
	<tr id="r_created_at">
		<td class="col-sm-2"><span id="elh_teachers_packages_created_at"><?php echo $teachers_packages->created_at->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->created_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_packages->updated_at->Visible) { // updated_at ?>
	<tr id="r_updated_at">
		<td class="col-sm-2"><span id="elh_teachers_packages_updated_at"><?php echo $teachers_packages->updated_at->FldCaption() ?></span></td>
...
<?php echo $teachers_packages->updated_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fteachers_packagesview.Init();
</script>
<?php
$teachers_packages_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$teachers_packages_view->Page_Terminate();
?>
