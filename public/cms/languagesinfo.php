...
class clanguages extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('languages', 'languages', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name_ar
		$this->name_ar = new cField('languages', 'languages', 'x_name_ar', 'name_ar', '`name_ar`', '`name_ar`', 201, -1, FALSE, '`name_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name_ar->Sortable = TRUE; // Allow sort
		$this->fields['name_ar'] = &$this->name_ar;

		// name_en
		$this->name_en = new cField('languages', 'languages', 'x_name_en', 'name_en', '`name_en`', '`name_en`', 201, -1, FALSE, '`name_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name_en->Sortable = TRUE; // Allow sort
		$this->fields['name_en'] = &$this->name_en;

		// created_at
		$this->created_at = new cField('languages', 'languages', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated_at
		$this->updated_at = new cField('languages', 'languages', 'x_updated_at', 'updated_at', '`updated_at`', ew_CastDateFieldForLike('`updated_at`', 0, "DB"), 135, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "languagesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "languagesadd.php")
