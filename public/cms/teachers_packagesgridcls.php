...
$teachers_packages_grid = NULL; // Initialize page object first

class cteachers_packages_grid extends cteachers_packages {
	...
	// Page object name
	var $PageObjName = 'teachers_packages_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_packagesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_packages"];
