...
$teachers_certificates_view = NULL; // Initialize page object first

class cteachers_certificates_view extends cteachers_certificates {
	...
	// Page object name
	var $PageObjName = 'teachers_certificates_view';
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "teachers_certificateslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "teachers_certificateslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($teachers_certificates_view)) $teachers_certificates_view = new cteachers_certificates_view();

// Page init
$teachers_certificates_view->Page_Init();

// Page main
$teachers_certificates_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$teachers_certificates_view->Page_Render();
?>
...
var CurrentForm = fteachers_certificatesview = new ew_Form("fteachers_certificatesview", "view");

// Form_CustomValidate event
fteachers_certificatesview.Form_CustomValidate = 
...
fteachers_certificatesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $teachers_certificates_view->ExportOptions->Render("body") ?>
<?php
	foreach ($teachers_certificates_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $teachers_certificates_view->ShowPageHeader(); ?>
<?php
$teachers_certificates_view->ShowMessage();
?>
<?php if (!$teachers_certificates_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($teachers_certificates_view->Pager)) $teachers_certificates_view->Pager = new cPrevNextPager($teachers_certificates_view->StartRec, $teachers_certificates_view->DisplayRecs, $teachers_certificates_view->TotalRecs, $teachers_certificates_view->AutoHidePager) ?>
<?php if ($teachers_certificates_view->Pager->RecordCount > 0 && $teachers_certificates_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($teachers_certificates_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $teachers_certificates_view->PageUrl() ?>start=<?php echo $teachers_certificates_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($teachers_certificates_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $teachers_certificates_view->PageUrl() ?>start=<?php echo $teachers_certificates_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $teachers_certificates_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($teachers_certificates_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $teachers_certificates_view->PageUrl() ?>start=<?php echo $teachers_certificates_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($teachers_certificates_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $teachers_certificates_view->PageUrl() ?>start=<?php echo $teachers_certificates_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $teachers_certificates_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fteachers_certificatesview" id="fteachers_certificatesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($teachers_certificates_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $teachers_certificates_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="teachers_certificates">
<input type="hidden" name="modal" value="<?php echo intval($teachers_certificates_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($teachers_certificates->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_teachers_certificates_id"><?php echo $teachers_certificates->id->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_teachers_certificates_teacher_id"><?php echo $teachers_certificates->teacher_id->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->university->Visible) { // university ?>
	<tr id="r_university">
		<td class="col-sm-2"><span id="elh_teachers_certificates_university"><?php echo $teachers_certificates->university->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->university->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->degree->Visible) { // degree ?>
	<tr id="r_degree">
		<td class="col-sm-2"><span id="elh_teachers_certificates_degree"><?php echo $teachers_certificates->degree->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->degree->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_teachers_certificates_image"><?php echo $teachers_certificates->image->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->from_date->Visible) { // from_date ?>
	<tr id="r_from_date">
		<td class="col-sm-2"><span id="elh_teachers_certificates_from_date"><?php echo $teachers_certificates->from_date->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->from_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_certificates->to_date->Visible) { // to_date ?>
	<tr id="r_to_date">
		<td class="col-sm-2"><span id="elh_teachers_certificates_to_date"><?php echo $teachers_certificates->to_date->FldCaption() ?></span></td>
...
<?php echo $teachers_certificates->to_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fteachers_certificatesview.Init();
</script>
<?php
$teachers_certificates_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$teachers_certificates_view->Page_Terminate();
?>
