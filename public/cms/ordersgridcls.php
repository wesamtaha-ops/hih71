...
$orders_grid = NULL; // Initialize page object first

class corders_grid extends corders {
	...
	// Page object name
	var $PageObjName = 'orders_grid';

	// Grid form hidden field names
	var $FormName = 'fordersgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["orders"];
