...
class ctopics extends cTable {
	...
	function __construct() {
		...
		// name_ar
		$this->name_ar = new cField('topics', 'topics', 'x_name_ar', 'name_ar', '`name_ar`', '`name_ar`', 201, -1, FALSE, '`name_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->name_ar->Sortable = TRUE; // Allow sort
		$this->fields['name_ar'] = &$this->name_ar;

		// name_en
		$this->name_en = new cField('topics', 'topics', 'x_name_en', 'name_en', '`name_en`', '`name_en`', 201, -1, FALSE, '`name_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->name_en->Sortable = TRUE; // Allow sort
		$this->fields['name_en'] = &$this->name_en;

		// parent_id
		$this->parent_id = new cField('topics', 'topics', 'x_parent_id', 'parent_id', '`parent_id`', '`parent_id`', 19, -1, FALSE, '`parent_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// image
		$this->image = new cField('topics', 'topics', 'x_image', 'image', '`image`', '`image`', 201, -1, FALSE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
