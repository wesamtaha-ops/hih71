...
$teachers_trains_view = NULL; // Initialize page object first

class cteachers_trains_view extends cteachers_trains {
	...
	// Page object name
	var $PageObjName = 'teachers_trains_view';
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "teachers_trainslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "teachers_trainslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($teachers_trains_view)) $teachers_trains_view = new cteachers_trains_view();

// Page init
$teachers_trains_view->Page_Init();

// Page main
$teachers_trains_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$teachers_trains_view->Page_Render();
?>
...
var CurrentForm = fteachers_trainsview = new ew_Form("fteachers_trainsview", "view");

// Form_CustomValidate event
fteachers_trainsview.Form_CustomValidate = 
...
fteachers_trainsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $teachers_trains_view->ExportOptions->Render("body") ?>
<?php
	foreach ($teachers_trains_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $teachers_trains_view->ShowPageHeader(); ?>
<?php
$teachers_trains_view->ShowMessage();
?>
<?php if (!$teachers_trains_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($teachers_trains_view->Pager)) $teachers_trains_view->Pager = new cPrevNextPager($teachers_trains_view->StartRec, $teachers_trains_view->DisplayRecs, $teachers_trains_view->TotalRecs, $teachers_trains_view->AutoHidePager) ?>
<?php if ($teachers_trains_view->Pager->RecordCount > 0 && $teachers_trains_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($teachers_trains_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $teachers_trains_view->PageUrl() ?>start=<?php echo $teachers_trains_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($teachers_trains_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $teachers_trains_view->PageUrl() ?>start=<?php echo $teachers_trains_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $teachers_trains_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($teachers_trains_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $teachers_trains_view->PageUrl() ?>start=<?php echo $teachers_trains_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($teachers_trains_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $teachers_trains_view->PageUrl() ?>start=<?php echo $teachers_trains_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $teachers_trains_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fteachers_trainsview" id="fteachers_trainsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($teachers_trains_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $teachers_trains_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="teachers_trains">
<input type="hidden" name="modal" value="<?php echo intval($teachers_trains_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($teachers_trains->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_teachers_trains_id"><?php echo $teachers_trains->id->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_trains->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_teachers_trains_teacher_id"><?php echo $teachers_trains->teacher_id->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_trains->instituation->Visible) { // instituation ?>
	<tr id="r_instituation">
		<td class="col-sm-2"><span id="elh_teachers_trains_instituation"><?php echo $teachers_trains->instituation->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->instituation->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_trains->subject->Visible) { // subject ?>
	<tr id="r_subject">
		<td class="col-sm-2"><span id="elh_teachers_trains_subject"><?php echo $teachers_trains->subject->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->subject->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_trains->from_date->Visible) { // from_date ?>
	<tr id="r_from_date">
		<td class="col-sm-2"><span id="elh_teachers_trains_from_date"><?php echo $teachers_trains->from_date->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->from_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($teachers_trains->to_date->Visible) { // to_date ?>
	<tr id="r_to_date">
		<td class="col-sm-2"><span id="elh_teachers_trains_to_date"><?php echo $teachers_trains->to_date->FldCaption() ?></span></td>
...
<?php echo $teachers_trains->to_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fteachers_trainsview.Init();
</script>
<?php
$teachers_trains_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$teachers_trains_view->Page_Terminate();
?>
