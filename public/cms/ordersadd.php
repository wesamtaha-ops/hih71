...
<?php if ($orders->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_orders_status" class="<?php echo $orders_add->LeftColumnClass ?>"><?php echo $orders->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($orders->created_at->Visible) { // created_at ?>
	<div id="r_created_at" class="form-group">
		<label id="elh_orders_created_at" for="x_created_at" class="<?php echo $orders_add->LeftColumnClass ?>"><?php echo $orders->created_at->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $orders_add->RightColumnClass ?>"><div<?php echo $orders->created_at->CellAttributes() ?>>
...
<?php if ($orders->updated_at->Visible) { // updated_at ?>
	<div id="r_updated_at" class="form-group">
		<label id="elh_orders_updated_at" for="x_updated_at" class="<?php echo $orders_add->LeftColumnClass ?>"><?php echo $orders->updated_at->FldCaption() ?></label>
		<div class="<?php echo $orders_add->RightColumnClass ?>"><div<?php echo $orders->updated_at->CellAttributes() ?>>
