...
$teachers_experiences_grid = NULL; // Initialize page object first

class cteachers_experiences_grid extends cteachers_experiences {
	...
	// Page object name
	var $PageObjName = 'teachers_experiences_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_experiencesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_experiences"];
