...
$teachers_grid = NULL; // Initialize page object first

class cteachers_grid extends cteachers {
	...
	// Page object name
	var $PageObjName = 'teachers_grid';

	// Grid form hidden field names
	var $FormName = 'fteachersgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers"];
