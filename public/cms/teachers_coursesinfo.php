...
$teachers_courses = NULL;

//
// Table class for teachers_courses
//
class cteachers_courses extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'teachers_courses';
		$this->TableName = 'teachers_courses';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`teachers_courses`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// teacher_id
		$this->teacher_id = new cField('teachers_courses', 'teachers_courses', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 19, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`teachers_courses`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "teachers_courseslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "teachers_coursesview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "teachers_coursesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "teachers_coursesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("teachers_coursesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("teachers_coursesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "teachers_coursesadd.php?" . $this->UrlParm($parm);
		else
			$url = "teachers_coursesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("teachers_coursesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("teachers_coursesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("teachers_coursesdelete.php", $this->UrlParm());
	}
