...
$teachers_courses_grid = NULL; // Initialize page object first

class cteachers_courses_grid extends cteachers_courses {
	...
	// Page object name
	var $PageObjName = 'teachers_courses_grid';

	// Grid form hidden field names
	var $FormName = 'fteachers_coursesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["teachers_courses"];
