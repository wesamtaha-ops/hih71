	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		if (checkrow) {
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $courses->name_ar->FldCaption(), $courses->name_ar->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_name_en");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $courses->name_en->FldCaption(), $courses->name_en->ReqErrMsg)) ?>");
...
// Check empty row
fcourseslist.EmptyRow = function(infix) {
	var fobj = this.Form;
...
if ($courses->CurrentAction == "gridadd") {
	$courses->CurrentFilter = "0=1";
	$courses_list->StartRec = 1;
	$courses_list->DisplayRecs = $courses->GridAddRowCount;
	$courses_list->TotalRecs = $courses_list->DisplayRecs;
	$courses_list->StopRec = $courses_list->DisplayRecs;
} else {
...
?>
<?php if ($courses->id->Visible) { // id ?>
	<?php if ($courses->SortUrl($courses->id) == "") { ?>
		<th data-name="id" class="<?php echo $courses->id->HeaderCellClass() ?>"><div id="elh_courses_id" class="courses_id"><div class="ewTableHeaderCaption"><?php echo $courses->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $courses->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $courses->SortUrl($courses->id) ?>',1);"><div id="elh_courses_id" class="courses_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $courses->id->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($courses->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($courses->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($courses->name_ar->Visible) { // name_ar ?>
	<?php if ($courses->SortUrl($courses->name_ar) == "") { ?>
		<th data-name="name_ar" class="<?php echo $courses->name_ar->HeaderCellClass() ?>"><div id="elh_courses_name_ar" class="courses_name_ar"><div class="ewTableHeaderCaption"><?php echo $courses->name_ar->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name_ar" class="<?php echo $courses->name_ar->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $courses->SortUrl($courses->name_ar) ?>',1);"><div id="elh_courses_name_ar" class="courses_name_ar">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $courses->name_ar->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($courses->name_ar->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($courses->name_ar->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($courses->name_en->Visible) { // name_en ?>
	<?php if ($courses->SortUrl($courses->name_en) == "") { ?>
		<th data-name="name_en" class="<?php echo $courses->name_en->HeaderCellClass() ?>"><div id="elh_courses_name_en" class="courses_name_en"><div class="ewTableHeaderCaption"><?php echo $courses->name_en->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name_en" class="<?php echo $courses->name_en->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $courses->SortUrl($courses->name_en) ?>',1);"><div id="elh_courses_name_en" class="courses_name_en">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $courses->name_en->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($courses->name_en->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($courses->name_en->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
while ($courses_list->RecCnt < $courses_list->StopRec) {
	...
	if (intval($courses_list->RecCnt) >= intval($courses_list->StartRec)) {
		...
		if ($courses->CurrentAction == "gridadd") // Grid add
			$courses->RowType = EW_ROWTYPE_ADD; // Render add
		if ($courses->CurrentAction == "gridadd" && $courses->EventCancelled && !$objForm->HasValue("k_blankrow")) // Insert failed
...
?>
	<?php if ($courses->id->Visible) { // id ?>
		<td data-name="id"<?php echo $courses->id->CellAttributes() ?>>
<?php if ($courses->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="courses" data-field="x_id" name="o<?php echo $courses_list->RowIndex ?>_id" id="o<?php echo $courses_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($courses->id->OldValue) ?>">
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_id" class="form-group courses_id">
<span<?php echo $courses->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $courses->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="courses" data-field="x_id" name="x<?php echo $courses_list->RowIndex ?>_id" id="x<?php echo $courses_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($courses->id->CurrentValue) ?>">
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_id" class="courses_id">
<span<?php echo $courses->id->ViewAttributes() ?>>
<?php echo $courses->id->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($courses->name_ar->Visible) { // name_ar ?>
		<td data-name="name_ar"<?php echo $courses->name_ar->CellAttributes() ?>>
<?php if ($courses->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_ar" class="form-group courses_name_ar">
<input type="text" data-table="courses" data-field="x_name_ar" name="x<?php echo $courses_list->RowIndex ?>_name_ar" id="x<?php echo $courses_list->RowIndex ?>_name_ar" placeholder="<?php echo ew_HtmlEncode($courses->name_ar->getPlaceHolder()) ?>" value="<?php echo $courses->name_ar->EditValue ?>"<?php echo $courses->name_ar->EditAttributes() ?>>
</span>
<input type="hidden" data-table="courses" data-field="x_name_ar" name="o<?php echo $courses_list->RowIndex ?>_name_ar" id="o<?php echo $courses_list->RowIndex ?>_name_ar" value="<?php echo ew_HtmlEncode($courses->name_ar->OldValue) ?>">
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_ar" class="form-group courses_name_ar">
<input type="text" data-table="courses" data-field="x_name_ar" name="x<?php echo $courses_list->RowIndex ?>_name_ar" id="x<?php echo $courses_list->RowIndex ?>_name_ar" placeholder="<?php echo ew_HtmlEncode($courses->name_ar->getPlaceHolder()) ?>" value="<?php echo $courses->name_ar->EditValue ?>"<?php echo $courses->name_ar->EditAttributes() ?>>
...
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_ar" class="courses_name_ar">
<span<?php echo $courses->name_ar->ViewAttributes() ?>>
<?php echo $courses->name_ar->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($courses->name_en->Visible) { // name_en ?>
		<td data-name="name_en"<?php echo $courses->name_en->CellAttributes() ?>>
<?php if ($courses->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_en" class="form-group courses_name_en">
<input type="text" data-table="courses" data-field="x_name_en" name="x<?php echo $courses_list->RowIndex ?>_name_en" id="x<?php echo $courses_list->RowIndex ?>_name_en" placeholder="<?php echo ew_HtmlEncode($courses->name_en->getPlaceHolder()) ?>" value="<?php echo $courses->name_en->EditValue ?>"<?php echo $courses->name_en->EditAttributes() ?>>
</span>
<input type="hidden" data-table="courses" data-field="x_name_en" name="o<?php echo $courses_list->RowIndex ?>_name_en" id="o<?php echo $courses_list->RowIndex ?>_name_en" value="<?php echo ew_HtmlEncode($courses->name_en->OldValue) ?>">
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_en" class="form-group courses_name_en">
<input type="text" data-table="courses" data-field="x_name_en" name="x<?php echo $courses_list->RowIndex ?>_name_en" id="x<?php echo $courses_list->RowIndex ?>_name_en" placeholder="<?php echo ew_HtmlEncode($courses->name_en->getPlaceHolder()) ?>" value="<?php echo $courses->name_en->EditValue ?>"<?php echo $courses->name_en->EditAttributes() ?>>
...
<?php } ?>
<?php if ($courses->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $courses_list->RowCnt ?>_courses_name_en" class="courses_name_en">
<span<?php echo $courses->name_en->ViewAttributes() ?>>
<?php echo $courses->name_en->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<span id="el$rowindex$_courses_name_ar" class="form-group courses_name_ar">
<input type="text" data-table="courses" data-field="x_name_ar" name="x<?php echo $courses_list->RowIndex ?>_name_ar" id="x<?php echo $courses_list->RowIndex ?>_name_ar" placeholder="<?php echo ew_HtmlEncode($courses->name_ar->getPlaceHolder()) ?>" value="<?php echo $courses->name_ar->EditValue ?>"<?php echo $courses->name_ar->EditAttributes() ?>>
</span>
<input type="hidden" data-table="courses" data-field="x_name_ar" name="o<?php echo $courses_list->RowIndex ?>_name_ar" id="o<?php echo $courses_list->RowIndex ?>_name_ar" value="<?php echo ew_HtmlEncode($courses->name_ar->OldValue) ?>">
</td>
...
<span id="el$rowindex$_courses_name_en" class="form-group courses_name_en">
<input type="text" data-table="courses" data-field="x_name_en" name="x<?php echo $courses_list->RowIndex ?>_name_en" id="x<?php echo $courses_list->RowIndex ?>_name_en" placeholder="<?php echo ew_HtmlEncode($courses->name_en->getPlaceHolder()) ?>" value="<?php echo $courses->name_en->EditValue ?>"<?php echo $courses->name_en->EditAttributes() ?>>
</span>
<input type="hidden" data-table="courses" data-field="x_name_en" name="o<?php echo $courses_list->RowIndex ?>_name_en" id="o<?php echo $courses_list->RowIndex ?>_name_en" value="<?php echo ew_HtmlEncode($courses->name_en->OldValue) ?>">
</td>
...
<?php } ?>
<?php if ($courses->CurrentAction == "gridadd") { ?>
