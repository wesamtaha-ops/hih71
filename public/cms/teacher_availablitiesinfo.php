...
$teacher_availablities = NULL;

//
// Table class for teacher_availablities
//
class cteacher_availablities extends cTable {
	var $id;
	var $teacher_id;
	var $date;
	var $time;
	...
	function __construct() {
		...
		$this->TableVar = 'teacher_availablities';
		$this->TableName = 'teacher_availablities';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`teacher_availablities`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('teacher_availablities', 'teacher_availablities', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// teacher_id
		$this->teacher_id = new cField('teacher_availablities', 'teacher_availablities', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 19, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date
		$this->date = new cField('teacher_availablities', 'teacher_availablities', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 0, "DB"), 133, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// time
		$this->time = new cField('teacher_availablities', 'teacher_availablities', 'x_time', 'time', '`time`', '`time`', 200, -1, FALSE, '`time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`teacher_availablities`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "teacher_availablitieslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "teacher_availablitiesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "teacher_availablitiesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("teacher_availablitiesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("teacher_availablitiesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "teacher_availablitiesadd.php?" . $this->UrlParm($parm);
		else
			$url = "teacher_availablitiesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("teacher_availablitiesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("teacher_availablitiesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("teacher_availablitiesdelete.php", $this->UrlParm());
	}
