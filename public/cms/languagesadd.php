...
flanguagesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($languages_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($languages->name_ar->Visible) { // name_ar ?>
	<div id="r_name_ar" class="form-group">
		<label id="elh_languages_name_ar" for="x_name_ar" class="<?php echo $languages_add->LeftColumnClass ?>"><?php echo $languages->name_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $languages_add->RightColumnClass ?>"><div<?php echo $languages->name_ar->CellAttributes() ?>>
...
<?php if ($languages->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_languages_name_en" for="x_name_en" class="<?php echo $languages_add->LeftColumnClass ?>"><?php echo $languages->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $languages_add->RightColumnClass ?>"><div<?php echo $languages->name_en->CellAttributes() ?>>
...
<?php if (!$languages_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $languages_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $languages_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
