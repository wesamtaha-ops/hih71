...
<?php if (!isset($orders_view->Pager)) $orders_view->Pager = new cPrevNextPager($orders_view->StartRec, $orders_view->DisplayRecs, $orders_view->TotalRecs, $orders_view->AutoHidePager) ?>
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $orders_view->PageUrl() ?>start=<?php echo $orders_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($orders_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $orders_view->PageUrl() ?>start=<?php echo $orders_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $orders_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($orders_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $orders_view->PageUrl() ?>start=<?php echo $orders_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($orders_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $orders_view->PageUrl() ?>start=<?php echo $orders_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<?php if ($orders->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_orders_id"><?php echo $orders->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $orders->id->CellAttributes() ?>>
<span id="el_orders_id">
<span<?php echo $orders->id->ViewAttributes() ?>>
<?php echo $orders->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->student_id->Visible) { // student_id ?>
	<tr id="r_student_id">
		<td class="col-sm-2"><span id="elh_orders_student_id"><?php echo $orders->student_id->FldCaption() ?></span></td>
...
<?php echo $orders->student_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->teacher_id->Visible) { // teacher_id ?>
	<tr id="r_teacher_id">
		<td class="col-sm-2"><span id="elh_orders_teacher_id"><?php echo $orders->teacher_id->FldCaption() ?></span></td>
...
<?php echo $orders->teacher_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->topic_id->Visible) { // topic_id ?>
	<tr id="r_topic_id">
		<td class="col-sm-2"><span id="elh_orders_topic_id"><?php echo $orders->topic_id->FldCaption() ?></span></td>
...
<?php echo $orders->topic_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_orders_date"><?php echo $orders->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $orders->date->CellAttributes() ?>>
<span id="el_orders_date">
<span<?php echo $orders->date->ViewAttributes() ?>>
<?php echo $orders->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->time->Visible) { // time ?>
	<tr id="r_time">
		<td class="col-sm-2"><span id="elh_orders_time"><?php echo $orders->time->FldCaption() ?></span></td>
		<td data-name="time"<?php echo $orders->time->CellAttributes() ?>>
<span id="el_orders_time">
<span<?php echo $orders->time->ViewAttributes() ?>>
<?php echo $orders->time->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->fees->Visible) { // fees ?>
	<tr id="r_fees">
		<td class="col-sm-2"><span id="elh_orders_fees"><?php echo $orders->fees->FldCaption() ?></span></td>
		<td data-name="fees"<?php echo $orders->fees->CellAttributes() ?>>
<span id="el_orders_fees">
<span<?php echo $orders->fees->ViewAttributes() ?>>
<?php echo $orders->fees->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->currency_id->Visible) { // currency_id ?>
	<tr id="r_currency_id">
		<td class="col-sm-2"><span id="elh_orders_currency_id"><?php echo $orders->currency_id->FldCaption() ?></span></td>
...
<?php echo $orders->currency_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_orders_status"><?php echo $orders->status->FldCaption() ?></span></td>
...
<?php echo $orders->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orders->meeting_id->Visible) { // meeting_id ?>
	<tr id="r_meeting_id">
		<td class="col-sm-2"><span id="elh_orders_meeting_id"><?php echo $orders->meeting_id->FldCaption() ?></span></td>
...
<?php echo $orders->meeting_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
