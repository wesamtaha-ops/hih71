...
//
class clanguages_levels extends cTable {
	var $id;
	var $name_ar;
	var $name_en;
	var $created_at;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('languages_levels', 'languages_levels', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name_ar
		$this->name_ar = new cField('languages_levels', 'languages_levels', 'x_name_ar', 'name_ar', '`name_ar`', '`name_ar`', 201, -1, FALSE, '`name_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name_ar->Sortable = TRUE; // Allow sort
		$this->fields['name_ar'] = &$this->name_ar;

		// name_en
		$this->name_en = new cField('languages_levels', 'languages_levels', 'x_name_en', 'name_en', '`name_en`', '`name_en`', 201, -1, FALSE, '`name_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name_en->Sortable = TRUE; // Allow sort
		$this->fields['name_en'] = &$this->name_en;

		// created_at
		$this->created_at = new cField('languages_levels', 'languages_levels', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated_at
		$this->updated_at = new cField('languages_levels', 'languages_levels', 'x_updated_at', 'updated_at', '`updated_at`', ew_CastDateFieldForLike('`updated_at`', 0, "DB"), 135, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`languages_levels`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "languages_levelslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "languages_levelsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "languages_levelsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("languages_levelsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("languages_levelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "languages_levelsadd.php?" . $this->UrlParm($parm);
		else
			$url = "languages_levelsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("languages_levelsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("languages_levelsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("languages_levelsdelete.php", $this->UrlParm());
	}
