...
class ccourses extends cTable {
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`courses`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "coursesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "coursesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("coursesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("coursesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "coursesadd.php?" . $this->UrlParm($parm);
		else
			$url = "coursesadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("coursesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("coursesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("coursesdelete.php", $this->UrlParm());
	}
