...
<?php echo $topics->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($topics->created_at->Visible) { // created_at ?>
	<tr id="r_created_at">
		<td class="col-sm-2"><span id="elh_topics_created_at"><?php echo $topics->created_at->FldCaption() ?></span></td>
...
<?php echo $topics->created_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($topics->updated_at->Visible) { // updated_at ?>
	<tr id="r_updated_at">
		<td class="col-sm-2"><span id="elh_topics_updated_at"><?php echo $topics->updated_at->FldCaption() ?></span></td>
...
<?php echo $topics->updated_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
