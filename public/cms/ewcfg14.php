...
define("EW_PROJECT_NAME", "hih71", TRUE); // Project name
...
$EW_RELATED_PROJECT_ID = "";
$EW_BODY_CLASS = "hold-transition skin-black-light";
...
define("EW_ADMIN_PASSWORD", "HihAdmin123!@#", TRUE); // Administrator password
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,webp", TRUE); // Allowed file extensions
...
define("EW_MAX_FILE_SIZE", 20000000, TRUE); // Max file size
