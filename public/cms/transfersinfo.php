...
//
class ctransfers extends cTable {
	var $id;
	var $user_id;
	var $amount;
	var $currency_id;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('transfers', 'transfers', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// amount
		$this->amount = new cField('transfers', 'transfers', 'x_amount', 'amount', '`amount`', '`amount`', 3, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new cField('transfers', 'transfers', 'x_type', 'type', '`type`', '`type`', 202, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verification_code
		$this->verification_code = new cField('transfers', 'transfers', 'x_verification_code', 'verification_code', '`verification_code`', '`verification_code`', 200, -1, FALSE, '`verification_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->verification_code->Sortable = TRUE; // Allow sort
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`transfers`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "transfersedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "transfersadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("transfersview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("transfersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "transfersadd.php?" . $this->UrlParm($parm);
		else
			$url = "transfersadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("transfersedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("transfersadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("transfersdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->verification_code->setDbValue($rs->fields('verification_code'));
