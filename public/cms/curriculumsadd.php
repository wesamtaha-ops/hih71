...
$curriculums_add = NULL; // Initialize page object first

class ccurriculums_add extends ccurriculums {
	...
	// Page object name
	var $PageObjName = 'curriculums_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("curriculumslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "curriculumsview.php")
...
// Create page object
if (!isset($curriculums_add)) $curriculums_add = new ccurriculums_add();

// Page init
$curriculums_add->Page_Init();

// Page main
$curriculums_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$curriculums_add->Page_Render();
?>
...
var CurrentForm = fcurriculumsadd = new ew_Form("fcurriculumsadd", "add");

// Validate form
fcurriculumsadd.Validate = function() {
...
fcurriculumsadd.Form_CustomValidate = 
...
fcurriculumsadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $curriculums_add->ShowPageHeader(); ?>
<?php
$curriculums_add->ShowMessage();
?>
<form name="fcurriculumsadd" id="fcurriculumsadd" class="<?php echo $curriculums_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($curriculums_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $curriculums_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="curriculums">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($curriculums_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($curriculums->name_ar->Visible) { // name_ar ?>
	<div id="r_name_ar" class="form-group">
		<label id="elh_curriculums_name_ar" for="x_name_ar" class="<?php echo $curriculums_add->LeftColumnClass ?>"><?php echo $curriculums->name_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $curriculums_add->RightColumnClass ?>"><div<?php echo $curriculums->name_ar->CellAttributes() ?>>
...
<?php if ($curriculums->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_curriculums_name_en" for="x_name_en" class="<?php echo $curriculums_add->LeftColumnClass ?>"><?php echo $curriculums->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $curriculums_add->RightColumnClass ?>"><div<?php echo $curriculums->name_en->CellAttributes() ?>>
...
<?php if (!$curriculums_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $curriculums_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $curriculums_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcurriculumsadd.Init();
</script>
<?php
$curriculums_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$curriculums_add->Page_Terminate();
?>
