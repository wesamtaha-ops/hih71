	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("countrieslist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fcountriesdelete = new ew_Form("fcountriesdelete", "delete");
...
fcountriesdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fcountriesdelete" id="fcountriesdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($countries_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $countries_delete->Token ?>">
<?php } ?>
...
<?php if ($countries->id->Visible) { // id ?>
		<th class="<?php echo $countries->id->HeaderCellClass() ?>"><span id="elh_countries_id" class="countries_id"><?php echo $countries->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($countries->name_ar->Visible) { // name_ar ?>
		<th class="<?php echo $countries->name_ar->HeaderCellClass() ?>"><span id="elh_countries_name_ar" class="countries_name_ar"><?php echo $countries->name_ar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($countries->name_en->Visible) { // name_en ?>
		<th class="<?php echo $countries->name_en->HeaderCellClass() ?>"><span id="elh_countries_name_en" class="countries_name_en"><?php echo $countries->name_en->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($countries->name_ar->Visible) { // name_ar ?>
		<td<?php echo $countries->name_ar->CellAttributes() ?>>
<span id="el<?php echo $countries_delete->RowCnt ?>_countries_name_ar" class="countries_name_ar">
...
<?php } ?>
<?php if ($countries->name_en->Visible) { // name_en ?>
		<td<?php echo $countries->name_en->CellAttributes() ?>>
<span id="el<?php echo $countries_delete->RowCnt ?>_countries_name_en" class="countries_name_en">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $countries_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
