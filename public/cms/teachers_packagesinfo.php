...
$teachers_packages = NULL;

//
// Table class for teachers_packages
//
class cteachers_packages extends cTable {
	var $id;
	var $teacher_id;
	var $title_en;
	var $title_ar;
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "`teachers_packages`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('teachers_packages', 'teachers_packages', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// teacher_id
		$this->teacher_id = new cField('teachers_packages', 'teachers_packages', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 19, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// title_en
		$this->title_en = new cField('teachers_packages', 'teachers_packages', 'x_title_en', 'title_en', '`title_en`', '`title_en`', 201, -1, FALSE, '`title_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->title_en->Sortable = TRUE; // Allow sort
		$this->fields['title_en'] = &$this->title_en;

		// title_ar
		$this->title_ar = new cField('teachers_packages', 'teachers_packages', 'x_title_ar', 'title_ar', '`title_ar`', '`title_ar`', 201, -1, FALSE, '`title_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->title_ar->Sortable = TRUE; // Allow sort
		$this->fields['title_ar'] = &$this->title_ar;

		// description_en
		$this->description_en = new cField('teachers_packages', 'teachers_packages', 'x_description_en', 'description_en', '`description_en`', '`description_en`', 201, -1, FALSE, '`description_en`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description_en->Sortable = TRUE; // Allow sort
		$this->fields['description_en'] = &$this->description_en;

		// description_ar
		$this->description_ar = new cField('teachers_packages', 'teachers_packages', 'x_description_ar', 'description_ar', '`description_ar`', '`description_ar`', 201, -1, FALSE, '`description_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description_ar->Sortable = TRUE; // Allow sort
		$this->fields['description_ar'] = &$this->description_ar;

		// image
		$this->image = new cField('teachers_packages', 'teachers_packages', 'x_image', 'image', '`image`', '`image`', 201, -1, FALSE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->image->Sortable = TRUE; // Allow sort
		$this->fields['image'] = &$this->image;

		// fees
		$this->fees = new cField('teachers_packages', 'teachers_packages', 'x_fees', 'fees', '`fees`', '`fees`', 3, -1, FALSE, '`fees`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fees->Sortable = TRUE; // Allow sort
		$this->fees->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['fees'] = &$this->fees;

		// currency_id
		$this->currency_id = new cField('teachers_packages', 'teachers_packages', 'x_currency_id', 'currency_id', '`currency_id`', '`currency_id`', 19, -1, FALSE, '`currency_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_at
		$this->created_at = new cField('teachers_packages', 'teachers_packages', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = TRUE; // Allow sort
		$this->created_at->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('teachers_packages', 'teachers_packages', 'x_updated_at', 'updated_at', '`updated_at`', ew_CastDateFieldForLike('`updated_at`', 0, "DB"), 135, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`teachers_packages`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "teachers_packageslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "teachers_packagesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "teachers_packagesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("teachers_packagesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("teachers_packagesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "teachers_packagesadd.php?" . $this->UrlParm($parm);
		else
			$url = "teachers_packagesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("teachers_packagesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("teachers_packagesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("teachers_packagesdelete.php", $this->UrlParm());
	}
