...
<?php if ($courses->name_ar->Visible) { // name_ar ?>
	<div id="r_name_ar" class="form-group">
		<label id="elh_courses_name_ar" for="x_name_ar" class="<?php echo $courses_add->LeftColumnClass ?>"><?php echo $courses->name_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $courses_add->RightColumnClass ?>"><div<?php echo $courses->name_ar->CellAttributes() ?>>
...
<?php if ($courses->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_courses_name_en" for="x_name_en" class="<?php echo $courses_add->LeftColumnClass ?>"><?php echo $courses->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $courses_add->RightColumnClass ?>"><div<?php echo $courses->name_en->CellAttributes() ?>>
