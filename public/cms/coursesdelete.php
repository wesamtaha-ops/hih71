...
<?php if ($courses->id->Visible) { // id ?>
		<th class="<?php echo $courses->id->HeaderCellClass() ?>"><span id="elh_courses_id" class="courses_id"><?php echo $courses->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($courses->name_ar->Visible) { // name_ar ?>
		<th class="<?php echo $courses->name_ar->HeaderCellClass() ?>"><span id="elh_courses_name_ar" class="courses_name_ar"><?php echo $courses->name_ar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($courses->name_en->Visible) { // name_en ?>
		<th class="<?php echo $courses->name_en->HeaderCellClass() ?>"><span id="elh_courses_name_en" class="courses_name_en"><?php echo $courses->name_en->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($courses->id->Visible) { // id ?>
		<td<?php echo $courses->id->CellAttributes() ?>>
<span id="el<?php echo $courses_delete->RowCnt ?>_courses_id" class="courses_id">
...
<?php } ?>
<?php if ($courses->name_ar->Visible) { // name_ar ?>
		<td<?php echo $courses->name_ar->CellAttributes() ?>>
<span id="el<?php echo $courses_delete->RowCnt ?>_courses_name_ar" class="courses_name_ar">
...
<?php } ?>
<?php if ($courses->name_en->Visible) { // name_en ?>
		<td<?php echo $courses->name_en->CellAttributes() ?>>
<span id="el<?php echo $courses_delete->RowCnt ?>_courses_name_en" class="courses_name_en">
