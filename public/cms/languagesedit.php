...
flanguagesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<?php if (!$languages_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($languages_edit->Pager)) $languages_edit->Pager = new cPrevNextPager($languages_edit->StartRec, $languages_edit->DisplayRecs, $languages_edit->TotalRecs, $languages_edit->AutoHidePager) ?>
<?php if ($languages_edit->Pager->RecordCount > 0 && $languages_edit->Pager->Visible) { ?>
<div class="ewPager">
...
<input type="hidden" name="modal" value="<?php echo intval($languages_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($languages->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_languages_id" class="<?php echo $languages_edit->LeftColumnClass ?>"><?php echo $languages->id->FldCaption() ?></label>
		<div class="<?php echo $languages_edit->RightColumnClass ?>"><div<?php echo $languages->id->CellAttributes() ?>>
...
<input type="hidden" data-table="languages" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($languages->id->CurrentValue) ?>">
<?php echo $languages->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($languages->name_ar->Visible) { // name_ar ?>
	<div id="r_name_ar" class="form-group">
		<label id="elh_languages_name_ar" for="x_name_ar" class="<?php echo $languages_edit->LeftColumnClass ?>"><?php echo $languages->name_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $languages_edit->RightColumnClass ?>"><div<?php echo $languages->name_ar->CellAttributes() ?>>
<span id="el_languages_name_ar">
<input type="text" data-table="languages" data-field="x_name_ar" name="x_name_ar" id="x_name_ar" placeholder="<?php echo ew_HtmlEncode($languages->name_ar->getPlaceHolder()) ?>" value="<?php echo $languages->name_ar->EditValue ?>"<?php echo $languages->name_ar->EditAttributes() ?>>
</span>
<?php echo $languages->name_ar->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($languages->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_languages_name_en" for="x_name_en" class="<?php echo $languages_edit->LeftColumnClass ?>"><?php echo $languages->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $languages_edit->RightColumnClass ?>"><div<?php echo $languages->name_en->CellAttributes() ?>>
<span id="el_languages_name_en">
<input type="text" data-table="languages" data-field="x_name_en" name="x_name_en" id="x_name_en" placeholder="<?php echo ew_HtmlEncode($languages->name_en->getPlaceHolder()) ?>" value="<?php echo $languages->name_en->EditValue ?>"<?php echo $languages->name_en->EditAttributes() ?>>
</span>
<?php echo $languages->name_en->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$languages_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $languages_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $languages_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
