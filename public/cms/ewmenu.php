...
$RootMenu->AddMenuItem(3, "mi_curriculums", $Language->MenuPhrase("3", "MenuText"), "curriculumslist.php", -1, "", IsLoggedIn() || AllowListMenu('{D43A73A4-5F37-4161-A00D-2E65107145C9}curriculums'), FALSE, FALSE, "");
