		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "countriesview.php")
...
var CurrentForm = fcountriesadd = new ew_Form("fcountriesadd", "add");
...
fcountriesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fcountriesadd" id="fcountriesadd" class="<?php echo $countries_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($countries_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $countries_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="countries">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($countries_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($countries->name_ar->Visible) { // name_ar ?>
	<div id="r_name_ar" class="form-group">
		<label id="elh_countries_name_ar" for="x_name_ar" class="<?php echo $countries_add->LeftColumnClass ?>"><?php echo $countries->name_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $countries_add->RightColumnClass ?>"><div<?php echo $countries->name_ar->CellAttributes() ?>>
...
<?php if ($countries->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_countries_name_en" for="x_name_en" class="<?php echo $countries_add->LeftColumnClass ?>"><?php echo $countries->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $countries_add->RightColumnClass ?>"><div<?php echo $countries->name_en->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $countries_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
