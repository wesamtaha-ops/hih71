...
$teachers_trains = NULL;

//
// Table class for teachers_trains
//
class cteachers_trains extends cTable {
	var $id;
	var $teacher_id;
	var $instituation;
	var $subject;
	...
	function __construct() {
		...
		$this->TableVar = 'teachers_trains';
		$this->TableName = 'teachers_trains';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`teachers_trains`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('teachers_trains', 'teachers_trains', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// teacher_id
		$this->teacher_id = new cField('teachers_trains', 'teachers_trains', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 19, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// instituation
		$this->instituation = new cField('teachers_trains', 'teachers_trains', 'x_instituation', 'instituation', '`instituation`', '`instituation`', 201, -1, FALSE, '`instituation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->instituation->Sortable = TRUE; // Allow sort
		$this->fields['instituation'] = &$this->instituation;

		// subject
		$this->subject = new cField('teachers_trains', 'teachers_trains', 'x_subject', 'subject', '`subject`', '`subject`', 201, -1, FALSE, '`subject`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->subject->Sortable = TRUE; // Allow sort
		$this->fields['subject'] = &$this->subject;

		// from_date
		$this->from_date = new cField('teachers_trains', 'teachers_trains', 'x_from_date', 'from_date', '`from_date`', ew_CastDateFieldForLike('`from_date`', 0, "DB"), 133, 0, FALSE, '`from_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// to_date
		$this->to_date = new cField('teachers_trains', 'teachers_trains', 'x_to_date', 'to_date', '`to_date`', ew_CastDateFieldForLike('`to_date`', 0, "DB"), 133, 0, FALSE, '`to_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`teachers_trains`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "teachers_trainslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "teachers_trainsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "teachers_trainsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("teachers_trainsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("teachers_trainsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "teachers_trainsadd.php?" . $this->UrlParm($parm);
		else
			$url = "teachers_trainsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("teachers_trainsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("teachers_trainsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("teachers_trainsdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->instituation->setDbValue($rs->fields('instituation'));
	...
	function RenderEditRow() {
		...
		$this->instituation->EditValue = $this->instituation->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->instituation->Exportable) $Doc->ExportCaption($this->instituation);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->instituation->Exportable) $Doc->ExportField($this->instituation);
